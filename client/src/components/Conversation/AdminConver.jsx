...
const AdminConver = ({ data, currentUser, online }) => {
    ...
    <>
      <div className="follower conversation">
        <div>
          ...
          <img
            src={userData?.profilePicture? REACT_APP_PUBLIC_FOLDER + userData.profilePicture : REACT_APP_PUBLIC_FOLDER + "defaultProfile.png"}
            alt="Profile"
